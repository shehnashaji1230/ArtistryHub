...
urlpatterns = [
    ...
    path('artwork/discount/',views.Add_DiscountView.as_view(),name='discount-add'),
    path('artwork/<int:pk>/',views.ArtWorkDetailView.as_view(),name='art-detail'),
    path('artwork/review/',views.ReviewCreateView.as_view(),name='add-review'),
    path('wishlist/add/<int:art_id>/', views.AddToWishListView.as_view(), name='add_to_wishlist'),
    path('customer/wishlist/',views.CustomerWishListView.as_view(),name="customer-wishlist"),
